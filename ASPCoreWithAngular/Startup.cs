...
using ASPCoreWithAngular.Logging;
...
namespace ASPCoreWithAngular
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<IPurchaseOrder, PurchaseOrderAccessLayer>();
            services.AddTransient<ILogin, LoginDataAccessLayer>();
            services.AddTransient<IOrderDetail, OrderDetailDataAccessLayer>();
